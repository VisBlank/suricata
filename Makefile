...
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/suricata.yaml.in $(top_srcdir)/configure \
	$(top_srcdir)/contrib/Makefile.in \
	$(top_srcdir)/contrib/file_processor/Action/Makefile.in \
	$(top_srcdir)/contrib/file_processor/Makefile.in \
	$(top_srcdir)/contrib/file_processor/Processor/Makefile.in \
	$(top_srcdir)/contrib/tile_pcie_logd/Makefile.in \
	$(top_srcdir)/doc/Makefile.in $(top_srcdir)/rules/Makefile.in \
...
CONFIG_CLEAN_FILES = rules/Makefile doc/Makefile contrib/Makefile \
	contrib/file_processor/Makefile \
	contrib/file_processor/Action/Makefile \
	contrib/file_processor/Processor/Makefile \
	contrib/tile_pcie_logd/Makefile suricata.yaml scripts/Makefile
...
ACLOCAL = ${SHELL} /home/coanor/suricata/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/coanor/suricata/missing --run autoconf
AUTOHEADER = ${SHELL} /home/coanor/suricata/missing --run autoheader
AUTOMAKE = ${SHELL} /home/coanor/suricata/missing --run automake-1.11
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -O0 -g -g3 -Wextra -Werror-implicit-function-declaration -fno-tree-pre -Wall -Wno-unused-parameter -std=gnu99 -march=native -DDEBUG -DNFQ -DHAVE_LIBNET11 -D_BSD_SOURCE -D__BSD_SOURCE -D__FAVOR_BSD -DHAVE_NET_ETHERNET_H  -I/usr/include -DLIBPCAP_VERSION_MAJOR=1 -DHAVE_PCAP_SET_BUFF -DHAVE_LIBCAP_NG -DREVISION="4ec3b0b"
CPP = gcc -std=gnu99 -E
CPPFLAGS = -I/usr/local/include/htp  -I/usr/local/include
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
DLLTOOL = false
...
LIBHTPMINVERSION_CFLAGS = -I/usr/local/include/htp -I/usr/local/lib/htp/include  
...
LIBS = -lmagic -lcap-ng -lhtp -lpcap -lnet -lnetfilter_queue -lnfnetlink -ljansson -lpthread -lyaml -lpcre 
...
LUAJIT_CFLAGS = 
LUAJIT_LIBS = 
MAKEINFO = ${SHELL} /home/coanor/suricata/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = suricata 2.0dev
...
STRIP = strip
VERSION = 2.0dev
abs_builddir = /home/coanor/suricata
abs_srcdir = /home/coanor/suricata
abs_top_builddir = /home/coanor/suricata
abs_top_srcdir = /home/coanor/suricata
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/coanor/suricata/install-sh
...
rules/Makefile: $(top_builddir)/config.status $(top_srcdir)/rules/Makefile.in
...
contrib/Makefile: $(top_builddir)/config.status $(top_srcdir)/contrib/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
contrib/file_processor/Makefile: $(top_builddir)/config.status $(top_srcdir)/contrib/file_processor/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
contrib/file_processor/Action/Makefile: $(top_builddir)/config.status $(top_srcdir)/contrib/file_processor/Action/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
contrib/file_processor/Processor/Makefile: $(top_builddir)/config.status $(top_srcdir)/contrib/file_processor/Processor/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
contrib/tile_pcie_logd/Makefile: $(top_builddir)/config.status $(top_srcdir)/contrib/tile_pcie_logd/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
